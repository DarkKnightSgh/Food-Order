...
// Assuming your database connection is established in session_m.php or another file
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $managerId = $_SESSION['login_user1'];

    // Prepare and execute the query
    $query = "INSERT INTO restaurants (name, email, contact, address, M_ID) VALUES ('$name', '$email', '$contact', '$address', '$managerId')";

    if ($conn->query($query) === TRUE) {
        // Redirect to myrestaurant.php after successful insertion
